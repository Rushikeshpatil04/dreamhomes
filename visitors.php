...
<div class="topbar">
  <div class="container">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">Visitors</h2>
			</div>
		</div>
	</div>
	</section>
...
<section class="section-padding gray-bg">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="section-title text-center">
						<h2><span class="coloured"></span> </h2>
						<p>"Welcome to the doorstep of your dreams. Step inside and let the journey to your perfect home begin. At Dream Homes Real Estate, we don't just sell houses; we craft dreams into reality. Your story starts here, where every visit becomes a step closer to home. Explore, imagine, and discover the extraordinary. Your dream home awaits, and you're just a click away from making it yours."</p>
					</div>
				</div>
			</div>
			...
			<div class="row service-v1 margin-bottom-40">
			    <div class="col-sm-4 md-margin-bottom-40">
               <img class="img-responsive" src="img/v6.jpg" alt="">   
                <h3>Mr & Mrs Roy</h3>
                <p></p>        
            </div>
            <div class="col-sm-4 md-margin-bottom-40">
                <img class="img-responsive" src="img/v4.jpg" alt="">            
                <h3>Mr & Mrs Bachhan</h3>
                <p></p>        
            </div>
            <div class="col-sm-4 md-margin-bottom-40">
              <img class="img-responsive" src="img/v5.jpg" alt="">  
                <h3>Miss Lina & Miss Rosy</h3>
                <p></p>        
            </div>
        </div>
		</div>
